...
The material of this course is based on the \href{https://github.com/mascaretti/moxier}{\textbf{moxier}} package.
It consists of a series of \href{https://rstudio.github.io/learnr/}{\textbf{learnr}} notebooks that will guide through your first steps into the wonderful world of statistics and statistical computing!
...
Some nice books are \citep{HandsOnProgrammingR2014} and

\hypertarget{licence}{%
\section{Licence}\label{licence}}

The \textbf{moxier} package is subject to the \href{https://www.r-project.org/Licenses/GPL-3}{GPL-3} licence.
...
\hypertarget{install-the-remote-package}{%
\subsection{\texorpdfstring{Install the \textbf{remote} package}{Install the remote package}}\label{install-the-remote-package}}

To install \textbf{moxier}, first of all you need to download the \textbf{remotes} package.
...
\hypertarget{install-moxier}{%
\subsection{\texorpdfstring{Install \textbf{moxier}}{Install moxier}}\label{install-moxier}}

You are now ready to install \textbf{moxier}!
Type into your console

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{remotes}\OperatorTok{::}\KeywordTok{install\_github}\NormalTok{(}\StringTok{"mascaretti/moxier"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## Skipping install of 'moxier' from a github remote, the SHA1 (2b8dfd2b) has not changed since last install.
